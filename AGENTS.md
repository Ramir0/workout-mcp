...
- **REST API**: `POST /import/csv` to ingest Hevy exports; `POST /sync/hevy` for on-demand Hevy API sync (incremental or full); `POST /webhooks/hevy` for real-time webhook notifications.
